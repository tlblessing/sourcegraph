...
type Mutation {
    ...
    Delete a graph.
    """
    deleteGraph(graph: ID!): EmptyResponse!
}
...
type Query {
    ...
    graphs(
        ...
        """
        Only return graphs that the viewer is affiliated with.
        """
...
type Graph implements Node {
    ...
    """
    The URL to the graph.
    """
    url: String!

    """
    The URL where the graph can be edited.
    """
    editURL: String!

    """
    Whether the viewer can update and delete this graph.
    """
    viewerCanAdminister: Boolean!

    """
    The date and time when the graph was created.
    """
    createdAt: DateTime!

    """
    The date and time when the graph was updated.
    """
    updatedAt: DateTime!
}
